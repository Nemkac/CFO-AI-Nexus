...
const partners = [
    { logo: '/assets/partners/una_logo_white.png', type: 'Diamond' },
...
const PartnersSection = () => {
    return (
        <div className="py-10 md:py-20 flex items-center w-full justify-center bg-linear-to-t from bg-surface-page to-surface-default">
            <div className='flex flex-col items-center justify-center max-w-6xl w-full p-4 gap-14'>
                <h2 className="text-h2 text-content-heading">Meet Our 2026 Sponsors</h2>
                <div className="flex flex-col items-center flex-wrap gap-8">
                    <h3 className="text-h3 text-content-heading">Diamond partner</h3>
                </div>
